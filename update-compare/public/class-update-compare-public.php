 ...
 * @subpackage Update_Compare/public
 */
...
class Update_Compare_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $update_compare       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->update_compare, plugin_dir_url( __FILE__ ) . 'css/update-compare-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->update_compare, plugin_dir_url( __FILE__ ) . 'js/update-compare-public.js', array( 'jquery' ), $this->version, false );
